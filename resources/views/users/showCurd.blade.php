...
<section id="mainAdminCurd" class="mainAdminCurd d-flex justify-content-center">
    ...
    <div class="contentCurdPage mt-5">
        <div class="d-flex SeachSection">
            <p class="mt-5 ms-5 center searchP"> {{ trans('slidebar.All users in YallaRehla Site') }}</p>
                                ...
                                <table class="w-full whitespace-no-wrap">
                                    <thead>
                                        <tr
                                            ...
                                            <th class="px-4 py-3">{{ trans('slidebar.User') }}</th>
                                            <th class="px-4 py-3">{{ trans('slidebar.NAME IN ENGILSH') }}</th>
                                            <th class="px-4 py-3">{{ trans('slidebar.EMAIL') }}</th>
                                            <th class="px-4 py-3">{{ trans('slidebar.TYPE') }}</th>
                                            <th class="px-4 py-3">{{ trans('slidebar.phone number') }}</th>
                                            <th class="px-4 py-3">{{trans('slidebar.Actions')}}</th>
                                        </tr>
                                    </thead>
                                            ...
                                            <tr class="text-gray-700 dark:text-gray-400">
                                                ...
                                                <td class="px-4 py-3">
                                                    <div class="flex items-center space-x-4 text-sm">
                                                        <form
                                                            action="{{ url('users/curdUsersToEditUser/' . $client->id) }}"
                                                            method="get">
                                                            @csrf
                                                            <button
